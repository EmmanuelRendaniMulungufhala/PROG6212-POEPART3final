    ...
    public class HRController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var processedClaims = await _context.Claims
                .Where(c => c.Status == ClaimStatus.Approved && c.ProcessingDays.HasValue)
                .ToListAsync();

            model.AverageProcessingDays = processedClaims.Any()
                ? processedClaims.Average(c => c.ProcessingDays!.Value)
                : 0;
