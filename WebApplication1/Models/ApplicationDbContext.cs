...
namespace WebApplication1.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Configure ClaimModel - ONLY map properties that exist in the database
            builder.Entity<ClaimModel>(entity =>
            {
                ...
                entity.Property(c => c.ApprovalNotes).HasMaxLength(500);
                entity.Property(c => c.AdditionalNotes).HasMaxLength(1000);
                ...
                entity.HasIndex(c => c.ApprovalDate);
            });
            ...
            builder.Entity<ClaimStatusHistory>(entity =>
            {
                ...
                entity.Property(h => h.ChangeNotes).HasMaxLength(500);
